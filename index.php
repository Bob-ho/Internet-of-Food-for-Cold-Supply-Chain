...
<html>
<head>
<title>Online Seafood Market</title>
<!-- for-mobile-apps -->
...
function moredetails(product)
{
	...
	xmlhttp.onreadystatechange = function() 
	{
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) 
		{
			...
			document.getElementById("myModal1").innerHTML=response;
						      
		}
	};
	xmlhttp.open("GET", "ajaxloadcommon.php?frompage=common&product=" + product, true);
	xmlhttp.send();
}
function addcarddetails(productid) 
{
	var xmlhttp = new XMLHttpRequest();
	xmlhttp.onreadystatechange = function() 
	{
	...
	xmlhttp.open("GET", "ajaxaddcard.php?frompage=saveorder&productid=" + productid, true);
	xmlhttp.send();
}
</script>
</head>
...
<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 ><a href="index.html"><!--<<b>T<br>H<br>E</b>-->CFSC<span>The Best Supermarket</span></a></h1>
			</div>
			<div class="head-t">
				<ul class="card">
					...
					{
					?>
					<li><a href="index.php?page=login.php" ><i class="fa fa-user" aria-hidden="true"></i>Login</a></li>
					<li><a href="index.php?page=register.php" ><i class="fa fa-arrow-right" aria-hidden="true"></i>Register</a></li>
					<?php	
					}
					?>
				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						...
						if($usertype=="Guest")
							...
							{
								include("deliveryboy_menu.php");
							}
							else if($usertype=="Customer")
							{
								include("customer_menu.php");
							}
							else if($usertype=="OtherBusiness")
							{
								include("otherbusiness_menu.php");
							}
						?>
					</div>
					</nav>
					<?php 
						...
						{
					?>
							<a href="index.php?page=checkout.php"> <div class="cart" >
...
if(isset($_GET["page"]))
{
	...
	if($page=="product_view" || $page=="product_view_single" || $page=="product_single")
	{
		$page="product";
	}
?>
<div class="banner-top">
	<div class="container">
		<h3 ><?php echo $page ?></h3>
		<h4><a href="index.php">Home</a><label>/</label><?php echo $page ?></h4>
		<div class="clearfix"> </div>
	</div>
</div>
<?php
...
<div class="footer">
	<div class="container">
		<div class="col-md-3 footer-grid">
			<h3>About Us</h3>
			<p>"Great place to eat tasty seafood and check out the large variety on offer." </p>
		</div>
		<div class="col-md-3 footer-grid ">
			<h3>Menu</h3>
			<ul>
				...
				<li><a href="index.php?page=product_view.php"> Product</a></li>
		...
		<div class="col-md-3 footer-grid ">
			...
			<ul>
				<li><a href="index.php?page=shipping.php">Shipping</a></li>
				<li><a href="index.php?page=terms.php">Terms & Conditions</a></li>
		...
		<div class="copy-right">
			<p> &copy; <?php echo date("Y"); ?> Big store. All Rights Reserved </p>
		</div>
	</div>
</div>
<!-- //footer-->
