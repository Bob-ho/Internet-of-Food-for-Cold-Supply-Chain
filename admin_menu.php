<ul class="nav navbar-nav ">
							...
							<!--<li class="dropdown ">
								<a href="#" class="dropdown-toggle  hyper" data-toggle="dropdown" ><span>About<b class="caret"></b></span></a>
								<ul class="dropdown-menu multi">
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
			
												<li><a href="index.php?page=login.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Login</a></li>
												<li><a href="index.php?page=register.php"><i class="fa fa-angle-right" aria-hidden="true"></i>Register</a></li>
												<li><a href="index.php?page=product_view.php"> <i class="fa fa-angle-right" aria-hidden="true"></i>Search</a></li>
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown" ><span>Contact us<b class="caret"></b></span></a>
							...
							<li><a href="index.php?page=about.php" class="hyper"> <span>About</span></a></li>
							<li><a href="index.php?page=contact.php" class="hyper"> <span>Contact</span></a></li>
							<li><a href="index.php?page=product_view.php" class="hyper"> <span>Product</span></a></li>
							<li><a href="index.php?page=bill.php&option=view" class="hyper"> <span>Bill</span></a></li>
							<li><a href="index.php?page=staff.php&option=view" class="hyper"> <span>Staff</span></a></li>
							<li><a href="index.php?page=customer.php&option=view" class="hyper"> <span>Customer</span></a></li>
