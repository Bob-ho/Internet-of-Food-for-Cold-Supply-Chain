		...
		<div class="spec ">
			...
			<div class="tab-head ">
				<nav class="nav-sidebar">
					<ul class="nav tabs ">
					  <li class="active"><a href="#tab1" data-toggle="tab">Fish</a></li>
					  <li class=""><a href="#tab2" data-toggle="tab">Crab</a></li> 
					  <li class=""><a href="#tab3" data-toggle="tab">Prawns</a></li>  
					  <li class=""><a href="#tab4" data-toggle="tab">Oysters</a></li>
					</ul>
				</nav>
