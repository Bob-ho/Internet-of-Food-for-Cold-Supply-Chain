...
?>
							...
							<?php
							$x=1;
							$sqlproductname="SELECT DISTINCT Food_Description FROM products";
							...
							<?php
								echo '<div class="spec ">
									<h3>'.$rowproductname["Food_Description"].'</h3>
									<div class="ser-t">
										<b></b>
										<span><i></i></span>
										<b class="line"></b>
								...
								$yyy=1;
								$sqlproductdetails="SELECT * FROM products WHERE Food_Description='$rowproductname[Food_Description]' ORDER BY Index_no";
								...
								while($rowproductdetails=mysql_fetch_assoc($resultproductdetails))
								{
									...
									if(mysql_num_rows($resultcheck)==0 && $yyy<=4)
									{
							...
							<?php
								...
								echo '<div class="add">';
									echo '<a href="index.php?page=product_view_single.php&product='.$rowproductname["Food_Description"].'"><button class="btn btn-danger my-cart-btn my-cart-b ">Click here for more products...</button></a>';
								echo '</div>';
							?>
									<div class="clearfix"></div>
								</div>
